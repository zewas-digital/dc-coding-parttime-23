...
function addToDo() {
    ...
    if (todoList !== null) {
        const what = document.querySelector("input[name='title']") as HTMLInputElement | null;
        const when = document.querySelector("input[name='date']") as HTMLInputElement | null;
...
function displayMatrix(htmlElement: { innerHTML: string; }, matrix: string | any[]) {
