// Kopie von typescriptSolution.js zu test.ts um zu schauen ob es möglich ist, ein javaScript project zu übernehmen?
// ja es ist möglich, es müssen Anpassungen am Code gemacht werden:
// Typ von aufgabe als any (Zeile 5) musste bzw. wurde von Jeremias ergänzt werden
...
// Demo, dass komplexe OOP in TypeScript möglich ist!!
class Zoo {
