...
public class Tier {
    ...
    public void setGesundheit(int neueGesundheit) {
        this.gesundheit = Math.min(neueGesundheit, this.maxGesundheit); // Stellt sicher, dass die Gesundheit das Maximum nicht überschreitet
    }
