...
public class ZooMikiArztSimulation extends Zoo {

    public ZooMikiArztSimulation(String name, int gruendungsjahr) {
    ...
    public static void main(String[] args) {
        ZooMikiArztSimulation zooMiki = new ZooMikiArztSimulation("ZooMiki", 2023);
