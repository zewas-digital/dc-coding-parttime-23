    ...
    public static <ex> void main(String[] args) {
        ...
        while ( true ) {
            ...
            if (kilometer > 0) {
                ...
                double kilometerNichtGefahren = auto1.fahren ( kilometer );
                if (kilometerNichtGefahren == 0) {
                    System.out.println ( auto1.kmStand );
                    System.out.println ( auto1.tankInhalt );
                }else{
                    System.out.println ("Es konnten "+ kilometerNichtGefahren+ " nicht gefahren werden" );
                    System.out.println ( auto1.kmStand );
                    System.out.println ( auto1.tankInhalt );
                }

            } else if (kilometer < 0) {
                double getankt = auto1.volltanken ( );
