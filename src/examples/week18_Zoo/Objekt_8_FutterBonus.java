...
public class Objekt_8_FutterBonus {
    ...
    public static Zoo erzeugeBeispielZoo() {
        ...
        // Tiere
        Tier rehKiez = waldrand.tierHinzufuegen("rehKiez", heu, 2, 100, 5);
        Tier rehBock = waldrand.tierHinzufuegen("rehBock", heu, 5, 100, 20);
        Tier luchs = weide.tierHinzufuegen("Luchs", fleisch, 1, 100, 40);
