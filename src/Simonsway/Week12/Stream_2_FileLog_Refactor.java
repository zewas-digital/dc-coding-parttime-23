...
Ergebnis:
   ...
   ...
*/
public class Stream_2_FileLog_Refactor {
    ...
    public static void log(int severity, String message) {
        ...
        try {
            ...
            DateTimeFormatter formatedTime = DateTimeFormatter
                    .ofPattern ( "yyyy-MM-dd HH:mm:ss" )
                    .withZone( java.time.ZoneId.of("UTC"));

            String formattedInstant = formatedTime.format(now);

            ps.println(formattedInstant + " / " + severityString + " / " + message);
            ps.close();
