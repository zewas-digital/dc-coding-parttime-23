package solutions.volkan.week4.example37;
...
public class LustigeSieben {
    public static void main(String[] args) {
        ...
        System.out.print("Bitte um Ihre Einsatz: ");
        int einsatz = scanner.nextInt();

        int kontostand = 0 - einsatz;

        System.out.print("Setzen Sie auf eine Zahl zwischen 2 und 12: ");
        int gesetztZahl = scanner.nextInt();

        System.out.print("Einsatz: " + einsatz);
        System.out.print(" Gesetz Zahl: " + gesetztZahl);

        int wuerfel1 = rollDice();
        int wuerfel2 = rollDice();
        int ergebnis = wuerfel1 + wuerfel2;
        System.out.println(" Die Würfel sind gefallen: " + wuerfel1 + " + " + wuerfel2 + " = " + ergebnis);

        if (ergebnis == 7 && gesetztZahl == 7){
            einsatz = einsatz * 3;
        } else if (ergebnis == gesetztZahl) {
            einsatz = einsatz * 2;
        }
        else if ((ergebnis == 2 || ergebnis == 4 || ergebnis == 6 || ergebnis == 9 || ergebnis == 11 ) && (gesetztZahl == 2 || gesetztZahl == 4 || gesetztZahl == 6 || gesetztZahl == 9 || gesetztZahl == 11)){
            einsatz = einsatz;
        }
        else if ((ergebnis == 3 || ergebnis == 5 || ergebnis == 8 || ergebnis == 10 || ergebnis == 12 ) && (gesetztZahl == 3 || gesetztZahl == 5 || gesetztZahl == 8 || gesetztZahl == 10 || gesetztZahl == 12)){
            einsatz = einsatz;
        }
        else {
            einsatz = 0;
        ...
        System.out.println("Ihr neuer Kontostand lautet: " + kontostand);
    }
