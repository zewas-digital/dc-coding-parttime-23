package solutions.alpi.week1.week3.example34;
...
public class ConfectionSizes {
    public static void main(String[] args) {
        ...
        System.out.println("Sind es Damen- oder Herrengrößen?");
        System.out.print("(d für Damen, h für Herren: ");
        String geschlecht = scanner.next();

        while (!geschlecht.equals("d") && !geschlecht.equals("h")) {
            System.out.println("Ungültige Eingabe.");
            System.out.println("Sind es Damen- oder Herrengrößen?");
            System.out.println("(d für Damen, h für Herren)");
            geschlecht = scanner.next();
        }

        System.out.println("Geben Sie die Konfektionsgröße ein: ");
        int konfektionsgroesse = scanner.nextInt();

        switch (geschlecht) {
            case "d":
                switch (konfektionsgroesse) {
                    case 32:
                        System.out.println("Damen 32 -> S");
                        break;
                    case 34:
                        System.out.println("Damen 34 -> M");
                        break;
                    case 36:
                        System.out.println("Damen 36 -> L");
                        break;
                    case 38:
                        System.out.println("Damen 38 -> XL");
                        break;
                    case 40:
                        System.out.println("Damen 40 -> XXL");
                        break;
                    default:
            ...
            case "h":
                switch (konfektionsgroesse) {
                    case 44:
                        System.out.println("Herren 44 -> S");
                        break;
                    case 46:
                        System.out.println("Herren 46 -> S");
                        break;
                    case 48:
                        System.out.println("Herren 48 -> L");
                        break;
                    case 50:
                        System.out.println("Herren 50 -> XL");
                        break;
                    case 52:
                        System.out.println("Herren 52 -> XXL");
                        break;
                    default:
                        System.out.println("Falsche eingabe!!!");
                }
