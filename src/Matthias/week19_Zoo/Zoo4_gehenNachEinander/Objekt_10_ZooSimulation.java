...
public class Objekt_10_ZooSimulation {
    public static void main( String[] args ) {
        ...
        //Gehege
        Gehege wildwiese=zoo1.addGehege("Ried" ,false);
        Gehege wuestenlandschaft=zoo1.addGehege( "Terrarium (warm)" ,false);
        Gehege blubberBecken=zoo1.addGehege( "Wasserplanschbecken" ,false);
