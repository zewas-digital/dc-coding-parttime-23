...
public class Objekt_1_Auto_Oliver {
    public static void main(String[] args) {
        oliver.week15_objects.Auto FordBronco = new oliver.week15_objects.Auto("Ford", "Bronco", 2023, 10000, 70);
        ...
        // umbau 80 Liter
        FordBronco = new oliver.week15_objects.Auto("Ford", "Bronco", 2023, 10000, 80);
       ...
       //System.out.println(FordBronco.kilometerstandFormatiert);
        ...
        oliver.week15_objects.Auto FiatPanda = new Auto("Fiat", "Panda", 2023, 5000, 30);
