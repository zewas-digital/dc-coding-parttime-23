...
public class Objekt_6_Zoo {
    ...
    public static void main(String[] args) {
        ...
        tiergartenDornbirn.addfutterPreis(heu, 0.20F);
        tiergartenDornbirn.addfutterPreis(mauese, 1.99F);

        //tiergartenDornbirn.futterPreisListe.forEach();

        tiergartenDornbirn.kalkulationBedarf(heu,hirsch2wild);
        tiergartenDornbirn.kalkulationBedarf(mauese,schlange1reptil);
