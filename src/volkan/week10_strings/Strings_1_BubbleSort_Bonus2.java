...
public class Strings_1_BubbleSort_Bonus2 {
    ...
    public static void main(String[] args) {
        ...
        // Bubblesort mit aufsteigender Sortierung nach 3. Buchstaben
        if (names[0].length() >= 3) {
            bubbleSort(names, 2);
            System.out.println("Aufsteigend nach 3. Buchstaben:");
            for (String name : names) {
                System.out.println(name);
            }
        } else {
            System.out.println("Sortierung nach 3. Buchstaben nicht möglich, da der String kürzer ist.");
        }

        // Bubblesort mit absteigender Sortierung nach 3. Buchstaben
        if (names[0].length() >= 3) {
            bubbleSort(names, 2);
            System.out.println("\nAbsteigend nach 3. Buchstaben:");
            for (String name : names) {
                System.out.println(name);
            }
        } else {
    ...
    public static void bubbleSort(String[] strings, int index) {
